...
const AddTask = ({ toggle, modal, save }) => {
                                ...
                                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <form className="p-4 md:p-5 ">
                                        ...
                                        <div className='flex mr-3 gap-3'>
                                            <button type='submit' onClick={handleSave} className="  text-white items-center bg-blue-700 hover:bg-blue-800  font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                                                Add Task
                                            </button>
